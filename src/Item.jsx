        ...
        <article className="learn-more text-center md:text-start md:col-span-3 md:grid md:grid-cols-2">
                ...
                {title === 'Transform your brand' ? (
                    <section className="px-5 py-10 lg:px-16 2xl:px-24 md:self-center md:row-start-1">
                        ...
                        {color === 'yellow' ? (
                                <a href="#" className="text-heading-text-color font-fraunces font-bold text-xl relative px-2 after:absolute after:w-full after:h-2 after:bg-link-yellow after:left-0 after:top-4 after:rounded-3xl after:-z-10 after:opacity-50 hover:after:opacity-100 hover:after:-rotate-3">
                                    <span className="relative">{cta}</span>
                                </a>
                            ) : (
                                <a href="#" className="text-heading-text-color font-fraunces font-bold text-xl relative px-2 after:absolute after:w-full after:h-2 after:bg-link-soft-red after:left-0 after:top-4 after:rounded-3xl after:-z-10 after:opacity-50 hover:after:opacity-100 hover:after:-rotate-3">
                                    <span className="relative">{cta}</span>
                                </a>
                            )}
                    </section>
